  ...
  _createClass(VideoPlayer, [{
    ...
    value: function init() {
      if (this.btns.length > 0) {
        ...
        firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); // Биндим кнопки
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindModuleTriggers",
    value: function bindModuleTriggers(selector, num) {
      var _this3 = this;
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this3.activeClass);
